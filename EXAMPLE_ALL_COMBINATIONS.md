...
-------------------------------------------------------------------------------
SPRING_APPLICATION_JSON='{"COLOR":"purple","CUSTOMER_URLS":{"CustomerA":"https://dev.example.com/customers/CustomerA.json","CustomerB":"https://dev.example.com/customers/CustomerB.json","CustomerC":"https://dev.example.com/customers/CustomerC.json","CustomerD":"https://dev.example.com/customers/CustomerD.json","CustomerE":"https://dev.example.com/customers/CustomerE.json"},"APP_ID":"myapp2"}'
...
-------------------------------------------------------------------------------
SPRING_APPLICATION_JSON='{"COLOR":"black","CUSTOMER_URLS":{"Alice'"'"'s shop":"https://alice.example.com/myapp2","Bob'"'"'s shop":"https://bob.example.com/myapp2"}}'
```
